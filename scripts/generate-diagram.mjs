...
// Write the mermaid source to a temporary file
const inputPath = 'scripts/diagram.mmd';
const outputPath = 'public/architecture-diagram.svg';

mkdirSync(dirname(inputPath), { recursive: true });
mkdirSync(dirname(outputPath), { recursive: true });

writeFileSync(inputPath, mermaidChart);

console.log('✅ Mermaid source file created at', inputPath);
console.log('Run: npx mmdc -i scripts/diagram.mmd -o public/architecture-diagram.svg -t dark -b transparent');